 ...
 * 
 * <p>
 * This example implements the MCP23017 raspberrypi.GPIO expansion board.
...
public class PiFaceGpioExample {
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        System.out.println("<--Pi4J--> PiFace (MCP23017) raspberrypi.GPIO Example ... started.");
        
        // create gpio controller
        final GpioController gpio = GpioFactory.getInstance();
        
        // create custom PiFace raspberrypi.GPIO provider

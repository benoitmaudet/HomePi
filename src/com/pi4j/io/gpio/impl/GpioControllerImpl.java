...
public class GpioControllerImpl implements GpioController {
    ...
    public void unexportAll() {
        // un-export all raspberrypi.GPIO pins that are currently exported
    ...
    public GpioPin provisionPin(GpioProvider provider, Pin pin, String name, PinMode mode) {
        ...
        // create new raspberrypi.GPIO pin instance
     ...
     * on the provisioned raspberrypi.GPIO pins
     * 
    ...
    /**
     * This method returns TRUE if the raspberrypi.GPIO controller has been shutdown.
     * 
    ...
    /**
     * This method can be called to forcefully shutdown all raspberrypi.GPIO controller
    ...
    public synchronized void shutdown()
    {
        ...
        // shutdown explicit configured raspberrypi.GPIO pins
        for (GpioPin pin : pins) {
            
            // perform a shutdown on the raspberrypi.GPIO provider for this pin

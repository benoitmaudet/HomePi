...
public class RaspiGpioProvider extends GpioProviderBase implements GpioProvider, GpioInterruptListener {
    ...
    public static final String NAME = "raspberrypi.RaspberryPi raspberrypi.GPIO Provider";
    ...
    public void export(Pin pin, PinMode mode) {
        ...
        //homepi.System.out.println("-- EXPORTING PIN [" + pin.getAddress() + "] to mode [" + mode.getName() + "]");
    ...
    public void setValue(Pin pin, double value) {
        ...
        throw new RuntimeException("This raspberrypi.GPIO provider does not support analog pins.");
    }

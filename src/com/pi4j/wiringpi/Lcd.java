 ...
 * first display needs 10 raspberrypi.GPIO pins and each additional display needs just one more pin, so with a
 * maximum of 17 raspberrypi.GPIO pins, that's 8 displays. If you move to using a 4-bit interface (trivial in
 ...
 * Pi, otherwise it will present 5V on the Pi's raspberrypi.GPIO pins which will not be good. At best you'll
...
public class Lcd {
     ...
     * 
     * <p>
     * The pin numbers will be either wiringPi pin numbers of raspberrypi.GPIO pin numbers depending on which

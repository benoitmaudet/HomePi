...
/**
 * <p> This class provides the event object for raspberrypi.GPIO interrupt state changes. </p>
 * 
 * <p>
...
public class GpioInterruptEvent extends EventObject {
     ...
     * 
     * @return raspberrypi.GPIO pin number (not header pin number; not wiringPi pin number)
     */
    public int getPin() {
        return pin;
    }
     ...
     * 
     * @return raspberrypi.GPIO pin state (HIGH=true, LOW=false)
     */
     ...
     * 
     * @return raspberrypi.GPIO pin state (HIGH=1, LOW=0)
     */

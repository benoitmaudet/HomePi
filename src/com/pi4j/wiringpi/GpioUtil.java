...
public class GpioUtil {
    ...
    /**
     * <p>raspberrypi.GPIO PIN DIRECTION</p>
     * <p>
     * raspberrypi.GPIO pin constant for IN direction for reading pin states
     * </p>
     * 
     * @see #export(int,int)
     ...
     * <p>raspberrypi.GPIO PIN DIRECTION</p>
     * <p>
     * raspberrypi.GPIO pin constant for OUT direction for writing digital pin states (0/1).
     * </p>
     * 
     * @see #export(int,int)
     * @see #setDirection(int,int)
    ...
    /**
     * <p>raspberrypi.GPIO PIN EDGE DETECTION</p>
     * <p>
    ...
    /**
     * <p>
     * This method will export the selected raspberrypi.GPIO pin.
     * </p>
     * <p>
    ...
    /**
     * <p>This method will unexport the selected raspberrypi.GPIO pin.</p>
    ...
    /**
     * <p>This method determines if the requested raspberrypi.GPIO pin is already exported.</p>
     * 
     * @param pin raspberrypi.GPIO pin number (not header pin number; not wiringPi pin number)
    ...
    /**
     * <p>This method will set the selected raspberrypi.GPIO pin's edge detection. Edge detection instructs when
     * the hardware raspberrypi.GPIO changes raise interrupts on the system.</p>
     * <p>
    ...
    /**
     * <p>This method will get the selected raspberrypi.GPIO pin's edge detection setting. Edge detection instructs
     * when the hardware raspberrypi.GPIO changes raise interrupts on the system.
     * </p>
     * 
     * @see #EDGE_NONE
     * @see #EDGE_BOTH
    ...
    /**
     * <p>This method will set the selected raspberrypi.GPIO pin's export direction.</p>
     * 
     * @see #DIRECTION_IN
     * @see #DIRECTION_OUT
     * 
    ...
    /**
     * <p>
     * This method will get the selected raspberrypi.GPIO pin's export direction.
     * </p>
     * 
     * @see #DIRECTION_IN
     * @see #DIRECTION_OUT
     * 
     * @param pin raspberrypi.GPIO pin number (not header pin number; not wiringPi pin number)
     * @return The raspberrypi.GPIO pin's configured export direction is returned: IN (0), OUT (1). </br>The

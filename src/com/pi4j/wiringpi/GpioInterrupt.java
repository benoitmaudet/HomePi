...
/**
 * <p>
 * This class provides static methods to configure the native Pi4J library to listen to raspberrypi.GPIO
 * interrupts and invoke callbacks into this class. Additionally, this class provides a listener
 * registration allowing Java consumers to subscribe to raspberrypi.GPIO pin state changes.
 * </p>
 * 
 * <p>
...
public class GpioInterrupt {
     ...
     * interrupts that represent changes to the selected raspberrypi.GPIO pin.
     * </p>
     * 
     * <p>
     * <b>The raspberrypi.GPIO pin must first be exported before it can be monitored.</b>
     * </p>
     * 
     ...
     *         represents success and that the raspberrypi.GPIO pin is already being monitored. A return value
     *         of '1' represents success and that a new monitoring thread was created to handle the
     *         requested raspberrypi.GPIO pin number.
     */
     ...
     * interrupts on the selected raspberrypi.GPIO pin.
     * </p>
     * 
     * @param pin raspberrypi.GPIO pin number (not header pin number; not wiringPi pin number)
     ...
     *         for the requested raspberrypi.GPIO pin number.
     */
     ...
     * raspberrypi.GPIO interrupt is detected. This method should not be called from any Java consumers. (Thus
     * is is marked as a private method.)
     * </p>
     * 
     * @param pin raspberrypi.GPIO pin number (not header pin number; not wiringPi pin number)
     * @param state New raspberrypi.GPIO pin state.
     */
    ...
    private static void pinStateChangeCallback(int pin, boolean state) {
        ...
        // homepi.System.out.println("raspberrypi.GPIO PIN [" + pin + "] = " + state);
    }
